...
#     E_dS_max_guess = 0.95
#     almost = 1e-6
#     EdS = ns.comp_E_dS_max(E_dS_max_guess, Omega_r0, Omega_m0, f_value, almost, fried_RHS_lambda)
...
filename_expansion = '/%s_expansion.txt.' %model
filename_force = '/%s_force.txt' %model
