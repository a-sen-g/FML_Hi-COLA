...
def read_in_parameters(horndeski_path, numerical_path):
    ...
    simulation_parameters = [Npoints, max_redshift, suppression_flag]
    ...
    return model_name, K, G3, G4, parameters, mass_ratio_list, symbol_list, closure_declaration, cosmological_parameters, initial_conditions, simulation_parameters, threshold_value, GR_flag
#####
